...
1. **Clone the repository:**
   ...
   ```bash
   git clone https://github.com/Sundsvallskommun/api-service-employee.git
   cd api-service-employee
   ```
...
```bash
curl -X GET "http://localhost:8080/api/v1/employee/employments" -H "accept: application/json"
```
